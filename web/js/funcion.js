$(function(){
    ...
    nombre.on('blur',function(){
        ...
        if (!/^\S+@\S+\.\S+$/.test(nombre.val())){
            nombre.parent().addClass('error').removeClass('success');
        }
        else{
            nombre.parent().removeClass('error').addClass('success');
        }
        
    });

    // Validate the apellido field
    apellido.on('blur',function(){
        
        // Very simple validation
        if (!/^\S+@\S+\.\S+$/.test(apellido.val())){
            apellido.parent().addClass('error').removeClass('success');
        }
        else{
            apellido.parent().removeClass('error').addClass('success');
        }
        
    });
    
    // Validate the edad field
    edad.on('blur',function(){
        
        // Very simple validation
        if (!/^\S+@\S+\.\S+$/.test(edad.val())){
            edad.parent().addClass('error').removeClass('success');
        }
        else{
            edad.parent().removeClass('error').addClass('success');
        }
